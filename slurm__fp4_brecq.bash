#!/bin/bash
# ─────────────────────────────────────────────────────────────────────────────
# slurm__fp4_brecq.bash  –  FP4 + BRECQ-AdaRound quantization + generation
#
# Usage:
#   bash slurm__fp4_brecq.bash
#   OUTDIR=my_output bash slurm__fp4_brecq.bash
# ─────────────────────────────────────────────────────────────────────────────

# ── Configurable from outside ─────────────────────────────────────────────────
OUTDIR="${OUTDIR:-outputs/fp4_brecq}"
CALI_DATA="${CALI_DATA:-pixart_calib_brecq.pt}"
CALI_ITERS="${CALI_ITERS:-20000}"
# ─────────────────────────────────────────────────────────────────────────────
...
echo "=========================================="
echo "Config:"
echo "  MODE          = FP4 + BRECQ-AdaRound"
echo "  OUTDIR        = ${OUTDIR}"
echo "  CALI_DATA     = ${CALI_DATA}"
echo "  CALI_ITERS    = ${CALI_ITERS}"
echo "=========================================="
...
# ── Run ───────────────────────────────────────────────────────────────────────
echo "Starting FP4 + BRECQ-AdaRound quantization and generation..."
...
echo "Submitted FP4 + BRECQ-AdaRound job."
